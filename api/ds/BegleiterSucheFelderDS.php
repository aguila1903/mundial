...
if ($lookFor == "spitzname") {
    $querySQL .= " ifnull(s.spitzname, '') as spitzname ";
}
// if ($lookFor == "land") {
...
$querySQL .= " From begleiter s Where begleiter_id > -1 "
...
// file_put_contents('BegleiterSucheFelderDS.txt', $querySQL);
