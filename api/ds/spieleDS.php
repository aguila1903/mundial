...
// $Where = " Where land != 'nb' ";
    ...
    $querySQL = "SELECT Distinct "
            . "	sp.spiel_id "
            . ", ifnull(sp.zusch_anzahl,0) as zusch_anzahl "
            . ", ifnull(sp.gaestefans,0) as gaestefans "
            . ", sp.bes_vork "
            . ", sp.sp_bericht "
            . ", sp.schiri_id"
            . ", sp.ausverkauft"
            ...
            . ", sp.erg_halb "
            . ", sp.erg_elfer "
            . ", ifnull(sp.sprit,0) as sprit "
            . ", ifnull(sp.bahn,0) as bahn "
            . ", ifnull(sp.flieger,0) as flieger "
            . ", ifnull(sp.uebernachtung,0) as uebernachtung "
            . ", ifnull(sp.verpflegung,0) as verpflegung "
            . ", ifnull(sp.sonstige,0) as sonstige "
            . ", ifnull(sp.schiff,0) as schiff "
            . ", ifnull(sp.souvenir,0) as souvenir "
            . ", ifnull(sp.taxi,0) as taxi "
            . ", ifnull(sp.handy,0) as handy "
            . ", ifnull(sp.sprit_anteilig,0) as sprit_anteilig "
            . ", sp.nr as anzahl "
            . ", ifnull(sp.eintrittskarte,0) as eintrittskarte "
            . ", sp.sonstige+sp.bahn+sp.eintrittskarte+sp.flieger+sp.uebernachtung+sp.verpflegung+sp.sprit+sp.sprit_anteilig+sp.schiff+sp.souvenir+sp.taxi+sp.handy as ges_kosten "
            . ", sp.erg_zusatz "
            ...
            . $likeFreieSuche
            . $freieSucheStad
            . " Order by sp.sp_datum desc, sp.zeit desc; "
    ;
