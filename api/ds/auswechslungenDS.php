...
if (isset($_REQUEST["status2"])) {  
    ...
    $querySQL = "SELECT Distinct "         
		...
		. " and sp.spieler_id not in (select sp2.spieler_id from sp_spieler_spiel_tabelle sp2 Where sp2.spiel_id = ". $spiel_id. " and sp2.status = 'sa' and status2 = ".$dbSyb->Quote($status2). " and sp2.aw = '1' )"
