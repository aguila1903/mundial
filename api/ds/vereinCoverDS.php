...
$querySQL = "select ifnull(dateiname,'no_image.jpg') as dateiname, id, media_id from media where id = ". $verein_id. " and ref = 'vn' and art = 'fr';";
